...
export default function Footer() {
  return (
    <footer style={{background:"#1A0A2E", color:"white"}}>
      <div style={{maxWidth:"1200px", margin:"0 auto", padding:"3rem 1.25rem", display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))", gap:"2rem"}}>
        ...
        <div>
          ...
          <p style={{color:"#C9B8D8", fontSize:"14px", lineHeight:"1.7", margin:0}}>
        ...
        <div>
          ...
          <ul style={{listStyle:"none", padding:0, margin:0, display:"flex", flexDirection:"column", gap:"0.5rem"}}>
            {[
              ...
              <li key={href}>
                <Link href={href} style={{color:"#C9B8D8", textDecoration:"none", fontSize:"13px"}}>{label}</Link>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div>
          ...
          <p style={{color:"#C9B8D8", fontSize:"13px", marginBottom:"1rem", lineHeight:"1.6"}}>
      ...
      <div style={{borderTop:"1px solid #3A2A52", textAlign:"center", padding:"1rem", color:"#A88FC0", fontSize:"12px"}}>
